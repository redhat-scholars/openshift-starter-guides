...
If you are on *ROKS* cluster create the pipeline with this command:
[.console-input]
[source,bash]
----
oc create -f https://raw.githubusercontent.com/openshift-roadshow/nationalparks/master/pipeline/nationalparks-pipeline-all-vfs.yaml -n %PROJECT_NAMESPACE%
----

Otherwise create the pipeline with this command:
[.console-input]
[source,bash]
----
...
You can run the Pipeline either from CLI than Web Console:

To start it with `oc`:
[.console-input]
[source,bash]
----
oc create -f https://raw.githubusercontent.com/openshift-roadshow/nationalparks/master/pipeline/nationalparks-pipelinerun.yaml -n %PROJECT_NAMESPACE%
----
