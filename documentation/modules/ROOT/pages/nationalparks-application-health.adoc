...
From *Workloads -> Topology*, click `nationalparks`. On the side panel, click the *Actions* dropdown menu and then select *Add Health Checks*.

image::nationalparks-application-health-menu.png[Add Health Checks]

On the *Add health checks* page, click *Add Readiness probe* and add in *Path* field:
...
Repeat the same procedure for the Liveness probe, click *Add Liveness probe* and add in *Path* field:
...
Both sections now show *Readiness probe added* and *Liveness probe added*. Finally confirm all new changes clicking to *Add*:
