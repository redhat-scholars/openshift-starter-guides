...
The **Edit Deployment** page opens in *Form view*. Scroll down to the **Environment Variables** section and add the following four entries. First set the server host and the database, using *Add value*:
