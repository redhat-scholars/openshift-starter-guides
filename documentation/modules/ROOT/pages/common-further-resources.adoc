...
* *link:https://developers.redhat.com/books/openshift-developers-guide-impatient-beginners/old[OpenShift
for Developers]*

image::further-resources-openshift-for-developers.png[OpenShift for Developers]

* *link:https://developers.redhat.com/books/devops-openshift-cloud-deployments-made-easy/old[DevOps with OpenShift]*
