...
image::nationalparks-databases-add-mongodb-to-workshop-app-js.png[Add mongodb to the workshop app]
...
[source,bash,role=copypaste,subs="+attributes,macros+"]
----
http://parksmap-{project-namespace}.%CLUSTER_SUBDOMAIN%
----
...
----
https://github.com/openshift-roadshow/nationalparks-js/blob/master/bin/config.js#L4-L11
----
