...
----
http://nationalparks-%PROJECT%.%CLUSTER_SUBDOMAIN%/ws/data/all
----
...
[source,bash,role=copypaste,subs="+attributes,macros+"]
----
http://nationalparks-%PROJECT%.%CLUSTER_SUBDOMAIN%/ws/data/load
----
...
[source,bash,role=copypaste,subs="+attributes,macros+"]
----
http://parksmap-%PROJECT%.%CLUSTER_SUBDOMAIN%
----
