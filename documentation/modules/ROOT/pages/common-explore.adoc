...
After you login to Developer Sandbox, you will be redirected into a **Developer Perspective**  with your default project.
...
image::devsandbox-topology.png[Topology View]
