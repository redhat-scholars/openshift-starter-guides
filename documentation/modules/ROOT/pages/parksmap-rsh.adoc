...
parksmap-5b66975f9b-zsktf   1/1     Running   0          52m
----
...
[source,bash,subs="+attributes,macros+"]
----
oc rsh parksmap-5b66975f9b-zsktf
----
...
[source,bash]
----
anaconda-post.log  bin  dev  etc  home  lib  lib64  media  mnt  opt  parksmap.jar  proc  root  run  sbin  srv  sys  tmp  usr  var
----
...
In order to access a pod's terminal via the Web Console, go to *Workloads -> Topology*, click the `parksmap` entry, open the *Resources* tab in the side panel and then click on the *Pod*.

image::parksmap-rsh-dev-console-pod.png[Pod in the web console]
...
[source,bash,subs="+attributes,macros+"]
----
oc exec parksmap-5b66975f9b-zsktf -- ls -l /parksmap.jar
----
...
[source,bash,subs="+attributes,macros+"]
----
oc rsh parksmap-5b66975f9b-zsktf whoami
----
