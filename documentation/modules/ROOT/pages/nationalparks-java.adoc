...
:cluster-subdomain: %CLUSTER_SUBDOMAIN%
...
nationalparks   nationalparks-{project-namespace}.{cluster-subdomain}             nationalparks   8080-tcp
parksmap        parksmap-{project-namespace}.{cluster-subdomain}                  parksmap        8080-tcp        edge        none
----
...
----
http://nationalparks-{project-namespace}.{cluster-subdomain}
----
...
link:http://nationalparks-{project-namespace}.{cluster-subdomain}/ws/info/[National Parks Info Page, role='params-link',window='_blank']
