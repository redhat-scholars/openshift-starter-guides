...
Select *Node.js* as your Builder Image, and be sure to select *Builder Image version* *20-ubi9* for this lab.
--
Python::
+
--
...
Select *Python* as your Builder Image, and be sure to select *Builder Image version* *3.9-ubi9* for this lab.
--
====
