...
NOTE: The application is built with link:https://quarkus.io[Quarkus], which requires Java 17 or newer, so the `openjdk-11-ubi8` tag used by previous versions of this lab will not work.
--
.NET::
+
--
